...
export default function Carrinho() {
    ...
    return (
        <Box bg={bg} minH="100vh">
            <Header />
            <Grid templateColumns={{ base: '1fr', md: '2fr 1fr' }} gap={6} maxW="1200px" mx="auto" p={8}>

                {/* Teste visual ainda não sei como receber informações do back - Lista de Produtos */}
                <GridItem>
                    <Heading size="lg" mb={4}>Carrinho</Heading>
                    <Stack spacing={4}>
                        {products.map((product) => (
                            <Flex key={product.id} p={4} borderWidth="1px" borderRadius="lg" alignItems="center">
                                <Image
                                    src={product.image}
                                    alt={product.name}
                                    boxSize="80px"
                                ...
                                <Box flex="1">
                                    ...
                                    <Text fontSize="sm" color={color}>{product.producer}</Text>
                                </Box>
                    ...
                    <Button mt={4} colorScheme="teal" variant="link">Continuar comprando</Button>
                </GridItem>

                {/* Teste visual ainda não sei como receber informações do back - Resumo do Pedido*/}
                <GridItem>
                    <Box p={6} borderWidth="1px" borderRadius="lg" bg={useColorModeValue('white', 'gray.700')}>
                        ...
                        <Button mt={4} colorScheme="green" width="full">Finalizar compra</Button>
                    </Box>
                    <Flex justifyContent="flex-end" mt={2}>
                        <Button colorScheme="red" variant="link">Cancelar pedidos</Button>
                    </Flex>
                </GridItem>
            </Grid>
        </Box>
